...
class RandomPolicy(Policy):
    ...
    def random_text(self):
        ...
        if text_style == 0:
            ...
            special_text=["www.baidu.com","www.google.com","t"]
    ...
    def choice_event(self,device,event_count):
        ...
        click_package_lists=[self.app.package_name,"android","com.android.settings","com.google.android","com.google.android.packageinstaller",
