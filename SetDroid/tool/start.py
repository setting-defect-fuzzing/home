...
def parse_args():
    ...
    parser.add_argument("-pro_click", action="store", dest="pro_click", required=False,
                        help="The percentage of click event", default=40)
    parser.add_argument("-pro_longclick", action="store", dest="pro_longclick", required=False,
                        help="The percentage of click event", default=20)
    ...
    parser.add_argument("-choice", action="store", dest="choice", required=False, default=0, type=int,
                        help="Run or replay")
    parser.add_argument("-emulator_path", action="store", dest="emulator_path", required=False, default="emulator",
                        help="Emulator path")
    parser.add_argument("-android_system", action="store", dest="android_system", required=False, default="11.0",
                        help="System of the device")
    parser.add_argument("-root_path", action="store", dest="root_path", required=False, default="../output/",
                        help="Output path")
    parser.add_argument("-emulator_name", action="store", dest="emulator_name", required=False, default="Android11.0",
    ...
    parser.add_argument("-rest_interval", action="store", dest="rest_interval", required=False, default=1, type=int,
                        help="time to sleep")
    parser.add_argument("-trace_path", action="store", dest="trace_path", required=False, default="E:/GitWorkspace/OutPut/com.tencent.mm/trace",
                        help="path of traces")
