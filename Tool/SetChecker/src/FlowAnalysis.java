...
public class FlowAnalysis extends ForwardFlowAnalysis<Unit, PatternFlowSet> {
    ...
    public FlowAnalysis(DirectedGraph graph, PatternFlowSet newset, JSONArray flowgens, JSONArray flowkills) {
        super(graph);
